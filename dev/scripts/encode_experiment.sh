...
echo "qp, cl, encoding_time(ms), original_size(bytes), encoded_size(bytes)" >> "../../results/${file_name}/benchmark_encoding.csv"
...
do
    ...
    do
        ...
        echo "qp: $qp, cl: $cl, encoding time: $encoding_time, original size: $original_size, encoded size: $encoded_size"
        echo "$qp, $cl, $encoding_time, $original_size, $encoded_size" >> "../../results/${file_name}/benchmark_encoding.csv"
    done
done

echo "Done encoding experiment results are saved in ../../results/${file_name}/benchmark_encoding.csv"